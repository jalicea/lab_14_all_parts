...
"""
print("Perhaps I can help you calculate the amount of cash for your tip!")
peo = int(raw_input("How many people?\n>"))
...
if peo<6:
    sev =raw_input("How was the service (terrible, poor, ok, good, great)? \n >")
    if sev == 'terrible':
        tip = 0
        tip = tip * cost
        print ("You should probably tip $" + str(tip) +"!" )
